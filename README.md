...
- Implemented a login API: `POST localhost:6000/v1/login`
  - Seed 2 users: `manager` and `user`

- Implemented product APIs:

- Get a list of products with pagination (permission: logged-in user)
  - `GET localhost:6000/v1/products`

- Create, update, and delete a product (permission: Manager)
  - `POST localhost:6000/v1/products`
  - `PUT localhost:6000/v1/products/:id`
  - `DELETE localhost:6000/v1/products/:id`
